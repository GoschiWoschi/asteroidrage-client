...
export function modV3(v: Vector3, n: number) {
    return v.set(
        mod(v.x, n),
        mod(v.y, n),
        mod(v.z, n)
...
export function hasCollision(p: Vector3, r: number, ps: Vector3[], rs: number[], boxSize: number, boxSizeHalf: number) {
